...
public class Ejercicio4 {
    ...
    public void backParticion(ArrayList<Integer> conjunto) {
        ...
        Solucion s = backParticionRec(conjunto, auxA, auxB, 0, 0, 0, null);
     ...
     */
    private Solucion backParticionRec(ArrayList<Integer> conjunto, ArrayList<Integer> auxA, ArrayList<Integer> auxB, int suma1, int suma2, int i, Solucion s) {
        if (i == conjunto.size()) {
        ...
        auxA.add(j);
        Solucion s1 = backParticionRec(conjunto, auxA, auxB, suma1 + j, suma2, i + 1, s);
        ...
        auxB.add(j);
        Solucion s2 = backParticionRec(conjunto, auxA, auxB, suma1, suma2 + j, i + 1, s);
